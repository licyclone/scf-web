...
$.extend($.fn, {
    initJerichoTab: function(setting) {
        ...
        function createJerichoTab() {
            ...
            */
            var jerichotab = $('<div id="'+opts.uniqueId+'" class="jericho_tab"><div class="tab_pages" ><div class="tabs"><ul /></div></div><div class="tab_content"><div id="jerichotab_contentholder" class="jerichotab_content" /></div></div>')
                                            .appendTo($(opts.renderTo));
            
            //apply contentcss to the contentholder
            $('.tab_content>.jerichotab_content', jerichotab).css(opts.contentCss);
