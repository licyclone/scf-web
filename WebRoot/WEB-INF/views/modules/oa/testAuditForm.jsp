			...
			<table class="table-form">
				<tr>
					<td class="tit">姓名</td><td>
						<sys:treeselectText id="user" name="user.id" value="${testAudit.user.id}" labelName="user.name" labelValue="${testAudit.user.name}" 
							title="用户" url="/sys/office/treeData?type=3" cssClass="required" cssStyle="" 
							allowClear="true" notAllowSelectParent="true" smallBtn="false"/>
					</td><td class="tit">部门</td>
					<td>
						<sys:treeselectText id="office" name="office.id" value="${testAudit.office.id}" labelName="office.name" labelValue="${testAudit.office.name}" 
							title="用户" url="/sys/office/treeData?type=2" cssClass="required" cssStyle="" 
							allowClear="true" notAllowSelectParent="true" smallBtn="false"/>
				...
				<tr>
					...
					<td><form:input path="oldb" htmlEscape="false" maxlength="50" cssClass="required"/></td>
					<td class="tit">月工资额</td>
