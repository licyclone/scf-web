						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-sm-4 controls">
									...
									<label class="col-sm-2 control-label">表单布局风格:</label>
					<div class="col-sm-4 controls">
					<form:select path="styleType" class="form-control">
						<form:option value="" label="请选择"/>
						<form:options items="${fns:getDictList('styleType')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>	
				</div>
							</div>
							<div class="form-group">
